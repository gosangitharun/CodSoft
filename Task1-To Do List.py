...
listbox_task=Listbox(frame_task,bg="white",fg="gray",height=30,width=50,font = "Bazooka")
...
#Button widget 
entry_button=Button(window,text="Add Task",width=40,command=entertask)
entry_button.pack(pady=4)

delete_button=Button(window,text="Delete selected Task",width=40,command=deletetask)
delete_button.pack(pady=4)

mark_button=Button(window,text="Mark as Completed ",width=40,command=markcompleted)
