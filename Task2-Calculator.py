...
btns_frame.pack()
clear = Button(btns_frame, text="AC", fg="white", width=32, height=3, bd=0, bg="#000000", cursor="hand2",
               command=lambda: bt_clear()).grid(row=0, column=0, columnspan=3, padx=1, pady=1)
divide = Button(btns_frame, text="/", fg="white", width=10, height=3, bd=0, bg="#000000", cursor="hand2",
...
multiply = Button(btns_frame, text="*", fg="white", width=10, height=3, bd=0, bg="#000000", cursor="hand2",
...
minus = Button(btns_frame, text="-", fg="white", width=10, height=3, bd=0, bg="#000000", cursor="hand2",
...
plus = Button(btns_frame, text="+", fg="white", width=10, height=3, bd=0, bg="#000000", cursor="hand2",
...
point = Button(btns_frame, text=".", fg="white", width=10, height=3, bd=0, bg="#000000", cursor="hand2",
               command=lambda: btn_click(".")).grid(row=4, column=2, padx=1, pady=1)
equals = Button(btns_frame, text="=", fg="white", width=10, height=3, bd=0, bg="#000000", cursor="hand2",
